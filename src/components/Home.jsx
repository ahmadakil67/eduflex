        ...
        <div>
            ...
            <section className="py-10 bg-gray-50">
                <div className="container mx-auto px-6">
                    <h2 className="text-3xl font-semibold text-center text-indigo-700 mb-8">Latest Courses</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {courses.length === 0 ? (
                            <p className="text-center text-lg text-gray-500">No courses available at the moment.</p>
                        ) : (
                            courses.map((course) => (
